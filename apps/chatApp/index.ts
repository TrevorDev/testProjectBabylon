...
shell.registerApp({
    ...
    launch: async (windowAnchor:BABYLON.Mesh, vrHelper: VRExperienceHelper)=>{
        ...
        var container = await BABYLON.SceneLoader.LoadAssetContainerAsync("https://raw.githubusercontent.com/rachyliu/assets/master/ChatApp.glb", "", scene)
        ...
        button.onPointerClickObservable.add(()=>{
            ...
            scene.onPointerDown = function (evt, pickResult) {
                ...
                if (pickResult.pickedMesh.id === "node_id32") {
                    ...
                    var advancedTexture = Stage.GUI.AdvancedDynamicTexture.CreateFullscreenUI("UI");
